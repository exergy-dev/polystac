...
- **Front I (deployment artifacts):** distroless multi-arch `Dockerfile`; `cmd/polystac-lambda` (provided.al2023); Helm chart with `values-pgstac.yaml` / `values-opensearch.yaml` overlays; SAM template; Terraform module.
