...
Deployment: composable Terraform modules at `deploy/terraform/modules/{lambda,server,pgstac,opensearch}` with example stacks at `deploy/terraform/examples/`. End-to-end walkthrough in `docs/deploy-aws.md`.
